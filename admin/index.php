...
// Get monthly uploads for last 6 months
 $monthly_uploads = [];
for ($i = 5; $i >= 0; $i--) {
    $month = date('Y-m', strtotime("-$i months"));
    $sql = "SELECT COUNT(*) as count FROM works WHERE DATE_FORMAT(created_at, '%Y-%m') = ?";
...
// Get works by status
 $status_data = [
    ['status' => 'Disetujui', 'count' => $karya_approved, 'color' => '#28a745'],
    ['status' => 'Menunggu', 'count' => $karya_pending, 'color' => '#ffc107'],
    ['status' => 'Ditolak', 'count' => $karya_rejected, 'color' => '#dc3545']
];
?>
...
<head>
    ...
    <title>Dashboard Admin - <?php echo get_setting('site_name'); ?></title>
    ...
    <div class="main-content">
        ...
        <div class="row">
            ...
            <div class="col-6 col-lg-3">
                <div class="stat-card">
                    ...
                    <h3 class="mb-1"><?php echo $karya_approved; ?></h3>
            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">Statistik Pengunggahan Karya (6 Bulan Terakhir)</h5>
                    </div>
                    <div class="card-body">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">Karya Berdasarkan Tipe</h5>
                    </div>
                    <div class="card-body">
                        <div class="chart-container">
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Karya Terbaru</h5>
                        <a href="works.php" class="btn btn-sm btn-outline-primary d-none d-md-block">Lihat Semua</a>
                    </div>
                            ...
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $work['full_name']; ?></td>
                                        <td><?php echo ucfirst($work['type']); ?></td>
                                        <td>
