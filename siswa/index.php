...
// Get user's works
 $user_id = get_user_id();
 $sql = "SELECT * FROM works WHERE user_id = ? ORDER BY created_at DESC";
...
<head>
    ...
    <title>Dashboard Siswa - <?php echo get_setting('site_name'); ?></title>
...
<body>
    ...
    <div class="main-content">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="mb-0">Dashboard Siswa</h2>
        ...
        <div class="card mb-4">
            <div class="card-body">
                <h4 class="mb-1">Selamat datang, <?php echo get_user_name(); ?>!</h4>
                <p class="text-muted mb-0">Kelas: <?php echo get_user_kelas(); ?></p>
            </div>
        </div>
            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Karya Saya</h5>
                        <a href="my_works.php" class="btn btn-sm btn-outline-primary">Lihat Semua</a>
                    </div>
                    <div class="card-body p-0">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    <?php 
                                    $display_count = min(5, count($works));
                        ...
                        <div class="text-center py-5">
                            ...
                            <p class="text-muted">Mulai unggah karya literasi Anda sekarang!</p>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            ...
                            <a href="../index.php#gallery" class="btn btn-outline-secondary">
